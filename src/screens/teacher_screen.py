...
def teacher_screen_register():
    ...
    teacher_name = st.text_input("Enter name", placeholder='Full Name')

    teacher_pass = st.text_input("Enter password", type='password', placeholder="Enter password")

    teacher_pass_confirm = st.text_input("Confirm your password", type='password', placeholder="Re-Enter password")
